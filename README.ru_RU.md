...
<p align="center">
    ...
    <a | SHOP_BONUS_DEVICES_COUNT | ⭕ | 1 | Ограничение по количеству устройств по умолчанию для пользователей промокодов, пробного периода и реферальной системы (на основе настроек плана) |
...
| | | |ttps://github.com/snoups/3xui-shop/blob/main/README.ru_RU.md"><u><b>РУССКИЙ</b></u></a>
</p>
